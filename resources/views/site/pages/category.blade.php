...
@section('content')
<section class="section-pagetop bg-dark" style="background-image:{{asset('storage/'.$category->image)}};background-repeat:no-repeat; !important">
    <div class="container clearfix">
        <h2 class="title-page">{{ $category->name }}</h2>
        <p class="title-desc">{{ $category->description }}</p>
    </div>
</section>
